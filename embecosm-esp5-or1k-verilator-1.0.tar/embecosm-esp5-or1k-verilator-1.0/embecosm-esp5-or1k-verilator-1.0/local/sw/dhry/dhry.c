...
/* variables for time measurement: Too_Small_Time is in uS */
 ...
 */
  ...
  prints ("Execution starts, ");
  printn (Number_Of_Runs, 10);
  prints (" runs through Dhrystone\n");
...
*/
 ...
 /* microseconds */
  ...
  {
    prints ("Measured time too small to obtain meaningful results\n");
    prints ("Please increase number of runs\n");
    prints ("\n");
  }
  else
  {
    ...
    Dhrystones_Per_Second = Number_Of_Runs * 1000000 / User_Time;
    prints ("Microseconds for one run through Dhrystone: ");
    printn (Microseconds, 10);
    prints ("us / ");
    printn (Number_Of_Runs, 10);
    prints (" runs\n");
    prints ("Dhrystones per Second:                      ");
    printn (Dhrystones_Per_Second, 10);
    prints (" \n");
  }
  report (0xdeaddead);
  return 0;
